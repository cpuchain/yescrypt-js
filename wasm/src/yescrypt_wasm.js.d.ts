...
interface WasmModule {
  _scrypt_wasm(_0: number, _1: number, _2: number, _3: number, _4: BigInt, _5: number): number;
  _yescrypt_wasm(_0: number, _1: number, _2: number, _3: number, _4: BigInt, _5: number): number;
